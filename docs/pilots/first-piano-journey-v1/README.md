# First Piano Journey — pilot pack v1

Materials for a **small usability sitting**. This pack does **not** authorize outreach, recording, or a public “it works” claim.
...
| Limit | Rule |
| --- | --- |
| Families | **3–5 max** for this v1 pack |
...
## What success means (usability, not efficacy)

A sitting is useful if we come away with **observations**:

- Could they open `/learn` and start L01 without a facilitator takeover?
- Where did they pause, guess, or ask for help?
- Did the yellow job make the next move clear?
- Did the grown-up use the helper view, or only sit beside the child?
- Would they try again later on this same browser?

A sitting is **not** a pass/fail on teaching quality. Do **not** write:

- learning-effectiveness claims
- “ready for grade 1”
- teacher-approved / educator-approved
- MIDI-verified technique
- guaranteed improvement

Adult notes about posture or fingers are **the adult’s eyes**, not app evidence. Keep those notes in a separate column from what the device stored.
...
Say this out loud (the script has the words):
...
| Action | Who |
| --- | --- |
| Draft this pack | Agent / Piany |
| Pick who to ask | Mitch |
| Send any invite or follow-up | **Only after Mitch says go** |
| Change DNS, pricing, or Vercel project | Mitch only — out of scope here |
| Claim the journey “works for kids” in public | Not authorized by this pack |

The invite text in [`recruiting-notes.md`](recruiting-notes.md) is marked **DO NOT SEND until Mitch authorizes outreach**.
